              ...
              chapter.longQuestions.map((lq, index) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <span className="h-8 w-8 rounded-lg bg-[#8B9A6B]/10 flex items-center justify-center text-sm font-medium text-[#8B9A6B] flex-shrink-0 group-hover:bg-[#8B9A6B]/20 transition-colors">
                      {index + 1}
                    </span>
                    <div className="flex-1">
                      <p className="text-[#2c2c2c] font-medium mb-2 group-hover:text-[#8B9A6B] transition-colors">{lq.question}</p>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs text-[#6b6b6b] opacity-0 group-hover:opacity-100 transition-opacity ml-auto">
